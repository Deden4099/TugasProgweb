...
if(isset($_GET['id_guru'])){
	...
	if($cek=='0'){
		...
		?><script language="javascript">document.location.href="?page=input_nilai_siswa&id_guru=<?php echo $id_guru;?>&id_pelajaran=<?php echo $id_pelajaran;?>&id_kelas=<?php echo $id_kelas;?>";</script><?php
	}else{
		//kalo sudah ada mode update
		?><script language="javascript">document.location.href="?page=input_nilai_update&id_guru=<?php echo $id_guru;?>&id_pelajaran=<?php echo $id_pelajaran;?>&id_kelas=<?php echo $id_kelas;?>";</script><?php
	}
...
<tr>
    ...
    <div id="content-table-inner">
		...
		<tr>
            ...
            <td><a href="?page=input_nilai&id_guru=<?php echo $id_guru;?>&id_pelajaran=<?php echo $row['id_pelajaran'];?>&id_kelas=<?php echo $row['id_kelas'];?>" style="text-decoration:underline" title="Pilih Mata Pelajaran"><?php echo $row['nama_pelajaran'];?></a></td>
